...
class User:
    def __init__(self, name, email, user_type, password, id_num=None):
...
class TicketCollection:
    ...
    def find_ticket(self, ticket_id):
        collection = self.collection
        ticket = collection
        return ticket.find_one({'id': ticket_id})
    ...
    def update_ticket(self, ticket):
        ...
        return collection.update_one(ticket_to_update, new_ticket)
    ...
    def get_tickets(self, worker_email=None, device_id=None):
        ...
        if worker_email is not None and device_id is not None:
    ...
    def get_worker(self, worker_email):
        ...
        if worker is not None:
            ...
            worker = Worker(worker['name'],
                            worker['email'],
                            worker['password'],
                            worker.get('user_type', 'default_value'),
                            worker['id'],
                            worker['team'])
            return worker
        else:
...
class Worker:
    def __init__(self, name, email, password, user_type, id_num, team_name):
        self.name = name
        self.email = email
        self.team = team_name
